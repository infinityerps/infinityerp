...
public class MexdlistMultiple extends HttpSecureAppServlet {
	private static final long serialVersionUID = 1L;
	  ...
	  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
	    ...
	    if (vars.commandIn("DEFAULT")) {
	      ...
	      String strKeyValue = vars.getGlobalVariable("inpKey", "MexdlistMultiple.key", "");
	      String strNameValue = vars.getGlobalVariable("inpName", "MexdlistMultiple.name", "");
	    
	      String strcontrolname = vars.getStringParameter("controlname");
	      if (!strcontrolname.equals(""))
	    	  vars.setSessionValue("MexdlistMultiple.controlname", strcontrolname );  
	      ...
	      String strcontrolname = vars.getGlobalVariable("inpcontrolname", "MexdlistMultiple.controlname", "");
	      ...
	      if (vars.getStringParameter("clear").equals("true")) {
	        vars.removeSessionValue("MexdlistMultiple.key");
	        vars.removeSessionValue("MexdlistMultiple.name");
	       // vars.removeSessionValue("MexdlistMultiple.controlname");
	      
	      }
	      String strKey = vars.getGlobalVariable("inpKey", "MexdlistMultiple.key", "");
	      String strName = vars.getGlobalVariable("inpName", "MexdlistMultiple.name", "");
	    
	      String strcontrolquery = vars.getGlobalVariable("MexdlistMultiple."+strcontrolname+".squery", "MexdlistMultiple."+strcontrolname+".squery", "");
	      //strOrg = vars.getOrg();
	  ...
	  private void PrintPage(HttpServletResponse response, VariablesSecureApp vars, String strKeyValue,
	    ...
	    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
	        "it/embio/exportdata/ad_forms/MexdlistMultiple").createXmlDocument();
	  ...
	  private void printGridData(HttpServletResponse response, VariablesSecureApp vars, String strKey,
	    ...
	    if (headers != null) {
	      try {
	        ...
	        page = TableSQLData.calcAndGetBackendPage(vars, "MexdlistMultipleData.currentPage");
	  ...
	  private void printGridDataSelectedRows(HttpServletResponse response, VariablesSecureApp vars,
	    ...
	    try {
	      ...
	      String strPage = vars.getSessionValue("MexdlistMultiple|currentPage", "0");
