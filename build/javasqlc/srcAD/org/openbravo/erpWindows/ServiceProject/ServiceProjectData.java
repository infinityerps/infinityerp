...
static Logger log4j = LogManager.getLogger();
  ...
  public static ServiceProjectData[] dummy(ConnectionProvider connectionProvider)    throws ServletException {
    return dummy(connectionProvider, 0, 0);
  }

  public static ServiceProjectData[] dummy(ConnectionProvider connectionProvider, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT '' AS dummy from DUAL";

    ResultSet result;
    Vector<ServiceProjectData> vector = new Vector<ServiceProjectData>(0);
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectServiceProjectData.dummy = UtilSql.getValue(result, "dummy");
