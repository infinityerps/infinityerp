...
static Logger log4j = LogManager.getLogger();
  ...
  public static ProductData[] dummy(ConnectionProvider connectionProvider)    throws ServletException {
    return dummy(connectionProvider, 0, 0);
  }

  public static ProductData[] dummy(ConnectionProvider connectionProvider, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectProductData.dummy = UtilSql.getValue(result, "dummy");
 ...
 */
  public static String selectActDefM_Product_Id(ConnectionProvider connectionProvider, String M_Product_Id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT Name FROM M_Product WHERE isActive='Y' AND M_Product_ID = ?  ";
