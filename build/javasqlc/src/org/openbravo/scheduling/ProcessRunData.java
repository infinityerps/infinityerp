...
static Logger log4j = LogManager.getLogger();
  ...
  public static int insert(ConnectionProvider connectionProvider, String adOrgId, String adClientId, String createdby, String updatedby, String id, String status, String runtime, String log, String processRequestId, String schedulerInstance)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, schedulerInstance);
