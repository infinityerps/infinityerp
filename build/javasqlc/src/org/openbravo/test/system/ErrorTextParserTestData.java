...
static Logger log4j = LogManager.getLogger();
  ...
  public static int setNotInDevelopment(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static int updateTableDescription(Connection conn, ConnectionProvider connectionProvider, String description, String adTableId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
