...
static Logger log4j = LogManager.getLogger();
  ...
  public static TreeData[] select(ConnectionProvider connectionProvider, String treeId, String parentNodeId, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    ResultSet result;
    Vector<TreeData> vector = new Vector<TreeData>(0);
  ...
  public static String getTreeTable(ConnectionProvider connectionProvider, String client, String tableId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT AD_TREE_ID AS ID " +
      "        FROM AD_TREE" +
