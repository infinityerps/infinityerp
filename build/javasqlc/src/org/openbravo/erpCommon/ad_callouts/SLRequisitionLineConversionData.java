...
class SLRequisitionLineConversionData implements FieldProvider {
static Logger log4j = LogManager.getLogger();
  ...
  public static SLRequisitionLineConversionData[] select(ConnectionProvider connectionProvider)    throws ServletException {
    return select(connectionProvider, 0, 0);
  }

  public static SLRequisitionLineConversionData[] select(ConnectionProvider connectionProvider, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT * FROM DUAL";

    ResultSet result;
    Vector<SLRequisitionLineConversionData> vector = new Vector<SLRequisitionLineConversionData>(0);
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        countRecord++;
        SLRequisitionLineConversionData objectSLRequisitionLineConversionData = new SLRequisitionLineConversionData();
        objectSLRequisitionLineConversionData.dummy = UtilSql.getValue(result, "dummy");
        objectSLRequisitionLineConversionData.InitRecordNumber = Integer.toString(firstRegister);
        vector.addElement(objectSLRequisitionLineConversionData);
    ...
    SLRequisitionLineConversionData objectSLRequisitionLineConversionData[] = new SLRequisitionLineConversionData[vector.size()];
    vector.copyInto(objectSLRequisitionLineConversionData);
    return(objectSLRequisitionLineConversionData);
  }
