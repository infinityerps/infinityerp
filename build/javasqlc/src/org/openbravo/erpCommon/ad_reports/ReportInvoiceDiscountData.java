...
static Logger log4j = LogManager.getLogger();
  ...
  public static ReportInvoiceDiscountData select(ConnectionProvider connectionProvider, String cCurrencyConv, String adUserClient, String adUserOrg, String datefrom, String dateto, String parBPartnerId, String discount)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "    WHERE QTY<>0" +
      "    AND 2=2";
    strSql = strSql + ((discount.equals("discount"))?"  AND (ROUND((ROUND(TOTALLINE/QTY,3)-ROUND(TOTALLINEDISCOUNT/QTY,3))/CASE WHEN ROUND(TOTALLINE/QTY,3) = 0 THEN 1 ELSE ROUND(TOTALLINE/QTY,3) END,2))*100 <>0 ":"");
    strSql = strSql + 
      "    ORDER BY NAME";
