 ...
 *   
 */
  public static ReportParetoProductData[] select(ConnectionProvider connectionProvider, String cCurrencyConv, String adClientId, String legalEntityId, String maxaggDate, String processTime, String dateTimeFormat, String mWarehouseId, String adOrgId, String language)    throws ServletException {
    return select(connectionProvider, cCurrencyConv, adClientId, legalEntityId, maxaggDate, processTime, dateTimeFormat, mWarehouseId, adOrgId, language, 0, 0);
  }
 ...
 *   
 */
  public static ReportParetoProductData[] select(ConnectionProvider connectionProvider, String cCurrencyConv, String adClientId, String legalEntityId, String maxaggDate, String processTime, String dateTimeFormat, String mWarehouseId, String adOrgId, String language, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "with " +
