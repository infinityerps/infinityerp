...
static Logger log4j = LogManager.getLogger();
  ...
  public static GeneralAccountingReportsData[] selectRptDouble(ConnectionProvider connectionProvider, String adOrgId)    throws ServletException {
    return selectRptDouble(connectionProvider, adOrgId, 0, 0);
  }

  public static GeneralAccountingReportsData[] selectRptDouble(ConnectionProvider connectionProvider, String adOrgId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
