...
static Logger log4j = LogManager.getLogger();
  ...
  public static ReportValuationStockData[] select(ConnectionProvider connectionProvider, String adLanguage, String cCurrencyConv, String legalEntity, String reportDate, String datePlus, String maxaggDate, String processTime, String dateTimeFormat, String organization, String warehouse, String costOrg, String costClient, String costType, String warehouseDimension, String categoryProduct)    throws ServletException {
    return select(connectionProvider, adLanguage, cCurrencyConv, legalEntity, reportDate, datePlus, maxaggDate, processTime, dateTimeFormat, organization, warehouse, costOrg, costClient, costType, warehouseDimension, categoryProduct, 0, 0);
  }
  ...
  public static ReportValuationStockData[] select(ConnectionProvider connectionProvider, String adLanguage, String cCurrencyConv, String legalEntity, String reportDate, String datePlus, String maxaggDate, String processTime, String dateTimeFormat, String organization, String warehouse, String costOrg, String costClient, String costType, String warehouseDimension, String categoryProduct, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, cCurrencyConv);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, reportDate);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, legalEntity);
  ...
  public static ReportValuationStockData[] selectClusteredByWarehouse(ConnectionProvider connectionProvider, String adLanguage, String reportDate, String legalEntity, String cCurrencyConv, String datePlus, String maxaggDate, String processTime, String dateTimeFormat, String organization, String warehouse, String categoryProduct, String costOrg, String costClient, String costType, String warehouseDimension, String filterOrgId)    throws ServletException {
    return selectClusteredByWarehouse(connectionProvider, adLanguage, reportDate, legalEntity, cCurrencyConv, datePlus, maxaggDate, processTime, dateTimeFormat, organization, warehouse, categoryProduct, costOrg, costClient, costType, warehouseDimension, filterOrgId, 0, 0);
  }
  ...
  public static String selectMaxAggregatedDate(ConnectionProvider connectionProvider, String adClient, String dateFilter, String organization)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "       SELECT MAX(dateto)" +
      "       FROM m_valued_stock_agg agg" +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      QueryTimeOutUtil.getInstance().setQueryTimeOut(st, SessionInfo.getQueryProfile());
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, adClient);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, dateFilter);
      if (organization != null && !(organization.equals(""))) {
        }
