...
static Logger log4j = LogManager.getLogger();
  ...
  public static InoutEditionData[] select(ConnectionProvider connectionProvider, String adLanguage, String adUserOrg, String adUserClient, String dateFrom, String dateTo, String cBPartnerId, String mWarehouseId, String cProjectId, String pgLimit, String oraLimit1)    throws ServletException {
    return select(connectionProvider, adLanguage, adUserOrg, adUserClient, dateFrom, dateTo, cBPartnerId, mWarehouseId, cProjectId, pgLimit, oraLimit1, 0, 0);
  }

  public static InoutEditionData[] select(ConnectionProvider connectionProvider, String adLanguage, String adUserOrg, String adUserClient, String dateFrom, String dateTo, String cBPartnerId, String mWarehouseId, String cProjectId, String pgLimit, String oraLimit1, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT B.* FROM (" +
    ...
    ResultSet result;
    Vector<InoutEditionData> vector = new Vector<InoutEditionData>(0);
