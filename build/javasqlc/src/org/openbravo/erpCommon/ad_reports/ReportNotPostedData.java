...
Select for relation
 */
  public static ReportNotPostedData[] select(ConnectionProvider connectionProvider, String adLanguage, String client, String parOrgs, String parDateFrom, String parDateTo)    throws ServletException {
    return select(connectionProvider, adLanguage, client, parOrgs, parDateFrom, parDateTo, 0, 0);
  }

/**
Select for relation
 */
  public static ReportNotPostedData[] select(ConnectionProvider connectionProvider, String adLanguage, String client, String parOrgs, String parDateFrom, String parDateTo, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "        where ad_client_id = ?" +
      "        and ad_org_id in (";
    strSql = strSql + ((parOrgs==null || parOrgs.equals(""))?"":parOrgs);
    strSql = strSql + 
      ")" +
      "        and 1=1";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, client);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, client);
      if (parOrgs != null && !(parOrgs.equals(""))) {
        }
