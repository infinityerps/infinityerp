 ...
 */
  public static ExpenseAPInvoiceData[] select(ConnectionProvider connectionProvider, String userClient, String userOrg, String dateReportFrom, String dateReportTo, String cBpartnerId, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    ResultSet result;
    Vector<ExpenseAPInvoiceData> vector = new Vector<ExpenseAPInvoiceData>(0);
...
Select for relation
 */
  public static String selectInvoiceHeader(Connection conn, ConnectionProvider connectionProvider, String adClientId, String adOrgId, String dateinvoiced, String cBpartnerId, String cCurrencyId, String cProjectId, String cActivityId, String cCampaignId, String cBpartnerLocationId, String paymentmethodId, String cPaymentTermId, String cCostcenterId, String aAssetId, String user1Id, String user2Id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  public static String selectInvoiceHeaderNoProject(Connection conn, ConnectionProvider connectionProvider, String adClientId, String adOrgId, String dateinvoiced, String cBpartnerId, String cCurrencyId, String cActivityId, String cCampaignId, String cBpartnerLocationId, String paymentmethodId, String cPaymentTermId, String cCostcenterId, String aAssetId, String user1Id, String user2Id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT MAX(C_INVOICE.C_INVOICE_ID) AS C_INVOICE_ID" +
      "      FROM C_INVOICE" +
