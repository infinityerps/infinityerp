...
static Logger log4j = LogManager.getLogger();
  ...
  public static SelectorUtilityData[] selectAllOrganizations(ConnectionProvider connectionProvider, String adOrgClient, String adUserClient)    throws ServletException {
    return selectAllOrganizations(connectionProvider, adOrgClient, adUserClient, 0, 0);
  }

  public static SelectorUtilityData[] selectAllOrganizations(ConnectionProvider connectionProvider, String adOrgClient, String adUserClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT AD_ORG.AD_ORG_ID AS ID, AD_ORG.NAME" +
      "      FROM AD_ORG" +
      "      WHERE AD_ORG.AD_ORG_ID IN (";
    strSql = strSql + ((adOrgClient==null || adOrgClient.equals(""))?"":adOrgClient);
    strSql = strSql + 
      ") " +
