...
static Logger log4j = LogManager.getLogger();
  ...
  public static MaterialReceiptPendingData[] select(ConnectionProvider connectionProvider, String cOrderlineId, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    ResultSet result;
    Vector<MaterialReceiptPendingData> vector = new Vector<MaterialReceiptPendingData>(0);
  ...
  public static MaterialReceiptPendingData[] selectLines(ConnectionProvider connectionProvider, String dateFormat, String adLanguage, String adUserClient, String adOrgId, String adUserOrgId, String parDateFrom, String parDateTo, String parBPartner, String parDocumentNo, String pgLimit, String oraLimit)    throws ServletException {
    return selectLines(connectionProvider, dateFormat, adLanguage, adUserClient, adOrgId, adUserOrgId, parDateFrom, parDateTo, parBPartner, parDocumentNo, pgLimit, oraLimit, 0, 0);
  }

  public static MaterialReceiptPendingData[] selectLines(ConnectionProvider connectionProvider, String dateFormat, String adLanguage, String adUserClient, String adOrgId, String adUserOrgId, String parDateFrom, String parDateTo, String parBPartner, String parDocumentNo, String pgLimit, String oraLimit, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT B.* FROM (" +
    ...
    strSql = strSql + 
      ")" +
      "      AND 1=1 AND C_ORDER.AD_ORG_ID IN (";
    strSql = strSql + ((adUserOrgId==null || adUserOrgId.equals(""))?"":adUserOrgId);
    strSql = strSql + 
      ")" +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      if (adUserOrgId != null && !(adUserOrgId.equals(""))) {
        }
  ...
  public static int insert(Connection conn, ConnectionProvider connectionProvider, String mInoutId, String adClientId, String adOrgId, String isactive, String createdby, String updatedby, String issotrx, String documentno, String docaction, String docstatus, String posted, String processing, String processed, String cDoctypeId, String description, String cOrderId, String dateordered, String isprinted, String movementtype, String movementdate, String dateacct, String cBpartnerId, String cBpartnerLocationId, String mWarehouseId, String poreference, String deliveryrule, String freightcostrule, String freightamt, String deliveryviarule, String mShipperId, String cChargeId, String chargeamt, String priorityrule, String generateto, String createfrom, String adUserId, String salesrepId, String adOrgtrxId, String cProjectId, String cCampaignId, String cActivityId, String user1Id, String user2Id, String updatelines, String islogistic, String cCostcenterId, String aAssetId)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "      	USER1_ID, USER2_ID, UPDATELINES, ISLOGISTIC, C_COSTCENTER_ID, A_ASSET_ID, PROCESS_GOODS_JAVA)" +
      "      VALUES(?,?,?,?,now(),?,now(),?," +
      "      	?,?,?,?,?,?,?," +
      "      	?,?,?,TO_DATE(?),?,?,TO_DATE(?)," +
      "      	TO_DATE(?),?,?,?,?," +
