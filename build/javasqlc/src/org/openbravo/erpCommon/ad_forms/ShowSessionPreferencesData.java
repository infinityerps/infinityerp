...
class ShowSessionPreferencesData implements FieldProvider {
static Logger log4j = LogManager.getLogger();
  ...
  public static ShowSessionPreferencesData[] select(ConnectionProvider connectionProvider, String windows)    throws ServletException {
    return select(connectionProvider, windows, 0, 0);
  }

  public static ShowSessionPreferencesData[] select(ConnectionProvider connectionProvider, String windows, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    ResultSet result;
    Vector<ShowSessionPreferencesData> vector = new Vector<ShowSessionPreferencesData>(0);
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        countRecord++;
        ShowSessionPreferencesData objectShowSessionPreferencesData = new ShowSessionPreferencesData();
        objectShowSessionPreferencesData.id = UtilSql.getValue(result, "id");
        objectShowSessionPreferencesData.name = UtilSql.getValue(result, "name");
        objectShowSessionPreferencesData.InitRecordNumber = Integer.toString(firstRegister);
        vector.addElement(objectShowSessionPreferencesData);
    ...
    ShowSessionPreferencesData objectShowSessionPreferencesData[] = new ShowSessionPreferencesData[vector.size()];
    vector.copyInto(objectShowSessionPreferencesData);
    return(objectShowSessionPreferencesData);
  }
  ...
  public static int updateRange(ConnectionProvider connectionProvider, String adUserId, String tadRecordrange, String tadTransactionalrange, String tadTheme)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      UPDATE AD_SYSTEM SET UPDATED=now(), UPDATEDBY = ?, TAD_RECORDRANGE=TO_NUMBER(?), TAD_TRANSACTIONALRANGE=TO_NUMBER(?), TAD_THEME=?" +
  ...
  public static int insert(ConnectionProvider connectionProvider, String adPreferenceId, String adClientId, String adOrgId, String adUserId, String attribute, String value)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
