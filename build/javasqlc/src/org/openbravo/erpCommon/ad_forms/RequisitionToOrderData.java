...
static Logger log4j = LogManager.getLogger();
  ...
  public static RequisitionToOrderData[] select(ConnectionProvider connectionProvider, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "          '' as GROSS_UNIT, '' AS GROSS_AMT, '' AS AUMQTY, '' AS AUMNAME, '' AS UOMPREFERENCE, '' AS HAVESECUOM, '' AS M_REQUISITION_ID" +
      "        FROM DUAL";

    ResultSet result;
    Vector<RequisitionToOrderData> vector = new Vector<RequisitionToOrderData>(0);
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectRequisitionToOrderData.mRequisitionId = UtilSql.getValue(result, "m_requisition_id");
  ...
  public static RequisitionToOrderData[] set()    throws ServletException {
    ...
    objectRequisitionToOrderData[0].mRequisitionId = "";
    return objectRequisitionToOrderData;
  }

  public static RequisitionToOrderData[] selectLines(ConnectionProvider connectionProvider, String adUserClient, String adOrgId, String parDateFrom, String parDateTo, String parProduct, String parRequester, String parVendorInc, String parVendor)    throws ServletException {
    return selectLines(connectionProvider, adUserClient, adOrgId, parDateFrom, parDateTo, parProduct, parRequester, parVendorInc, parVendor, 0, 0);
  }

  public static RequisitionToOrderData[] selectLines(ConnectionProvider connectionProvider, String adUserClient, String adOrgId, String parDateFrom, String parDateTo, String parProduct, String parRequester, String parVendorInc, String parVendor, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    strSql = strSql + 
      ")" +
      "          AND M_REQUISITION.DEFAULT_ACTION = 'PO'" +
      "          AND 1=1";
  ...
  public static RequisitionToOrderData[] linesToOrder(ConnectionProvider connectionProvider, String currency, String orderdate, String org, String warehouse, String billto, String shipto, String pricelistversion, String parRequisitionLines)    throws ServletException {
    return linesToOrder(connectionProvider, currency, orderdate, org, warehouse, billto, shipto, pricelistversion, parRequisitionLines, 0, 0);
  }

  public static RequisitionToOrderData[] linesToOrder(ConnectionProvider connectionProvider, String currency, String orderdate, String org, String warehouse, String billto, String shipto, String pricelistversion, String parRequisitionLines, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "          M_REQUISITIONLINE.needbydate, M_REQUISITIONLINE.M_REQUISITION_ID" +
  ...
  public static RequisitionToOrderData[] selectAUMDefault(ConnectionProvider connectionProvider, String mProductId, String adClientId, String adOrgId)    throws ServletException {
    return selectAUMDefault(connectionProvider, mProductId, adClientId, adOrgId, 0, 0);
  }

  public static RequisitionToOrderData[] selectAUMDefault(ConnectionProvider connectionProvider, String mProductId, String adClientId, String adOrgId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
