...
static Logger log4j = LogManager.getLogger();
  ...
  public static DocLineLandedCostData[] select(ConnectionProvider connectionProvider, String LC_Reference_Date, String LC_Receiptline_Amt)    throws ServletException {
    return select(connectionProvider, LC_Reference_Date, LC_Receiptline_Amt, 0, 0);
  }

  public static DocLineLandedCostData[] select(ConnectionProvider connectionProvider, String LC_Reference_Date, String LC_Receiptline_Amt, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, LC_Reference_Date);
      ...
      while(continueResult && result.next()) {
        ...
        objectDocLineLandedCostData.dateacct = UtilSql.getDateValue(result, "dateacct", "dd-MM-yyyy");
