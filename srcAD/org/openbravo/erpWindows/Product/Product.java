...
public class Product extends HttpSecureAppServlet {
  ...
  public void service(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (command.contains("BUTTON")) {
     ...
     SessionInfo.setQueryProfile("manualProcess");
      ...
      if (command.contains("58591E3E0F7648E4A09058E037CE49FC")) {
        SessionInfo.setProcessType("P");
        SessionInfo.setProcessId("58591E3E0F7648E4A09058E037CE49FC");
        SessionInfo.setModuleId("0");
      }
      ...
      if (explicitAccess.contains("58591E3E0F7648E4A09058E037CE49FC") || (securedProcess && command.contains("58591E3E0F7648E4A09058E037CE49FC"))) {
        classInfo.type = "P";
        classInfo.id = "58591E3E0F7648E4A09058E037CE49FC";
      }
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT", "DIRECT", "TAB", "SEARCH", "RELATION", "NEW", "EDIT", "NEXT",
      ...
      throw new OBException("2.50 style command is no longer supported: " + vars.getCommand());
    ...
    } else if (vars.commandIn("BUTTONUpdateinvariants58591E3E0F7648E4A09058E037CE49FC")) {
        vars.setSessionValue("button58591E3E0F7648E4A09058E037CE49FC.strupdateinvariants", vars.getStringParameter("inpupdateinvariants"));
        vars.setSessionValue("button58591E3E0F7648E4A09058E037CE49FC.strProcessing", vars.getStringParameter("inpprocessing", "Y"));
        vars.setSessionValue("button58591E3E0F7648E4A09058E037CE49FC.strOrg", vars.getStringParameter("inpadOrgId"));
        vars.setSessionValue("button58591E3E0F7648E4A09058E037CE49FC.strClient", vars.getStringParameter("inpadClientId"));
        ...
        //Save in session needed params for combos if needed
        vars.setSessionObject("button58591E3E0F7648E4A09058E037CE49FC.originalParams", FieldProviderFactory.getFieldProvider(p));
        printPageButtonFS(response, vars, "58591E3E0F7648E4A09058E037CE49FC", request.getServletPath());
      } else if (vars.commandIn("BUTTON58591E3E0F7648E4A09058E037CE49FC")) {
        String strM_Product_ID = vars.getGlobalVariable("inpmProductId", windowId + "|M_Product_ID", "");
        String strupdateinvariants = vars.getSessionValue("button58591E3E0F7648E4A09058E037CE49FC.strupdateinvariants");
        String strProcessing = vars.getSessionValue("button58591E3E0F7648E4A09058E037CE49FC.strProcessing");
        String strOrg = vars.getSessionValue("button58591E3E0F7648E4A09058E037CE49FC.strOrg");
        String strClient = vars.getSessionValue("button58591E3E0F7648E4A09058E037CE49FC.strClient");
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonUpdateinvariants58591E3E0F7648E4A09058E037CE49FC(response, vars, strM_Product_ID, strupdateinvariants, strProcessing);
        }
        ...
        printPageClosePopUp(response, vars);
    } else if (vars.commandIn("SAVE_BUTTONUpdateinvariants58591E3E0F7648E4A09058E037CE49FC")) {
        String strM_Product_ID = vars.getGlobalVariable("inpKey", windowId + "|M_Product_ID", "");
        
        ProcessBundle pb = new ProcessBundle("58591E3E0F7648E4A09058E037CE49FC", vars).init(this);
        HashMap<String, Object> params= new HashMap<String, Object>();
...
params.put("mChValueId", strmChValueId);
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    void printPageButtonUpdateinvariants58591E3E0F7648E4A09058E037CE49FC(HttpServletResponse response, VariablesSecureApp vars, String strM_Product_ID, String strupdateinvariants, String strProcessing)
    throws IOException, ServletException {
      log4j.debug("Output: Button process 58591E3E0F7648E4A09058E037CE49FC");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/Updateinvariants58591E3E0F7648E4A09058E037CE49FC", discard).createXmlDocument();
      xmlDocument.setParameter("key", strM_Product_ID);
      xmlDocument.setParameter("processing", strProcessing);
      xmlDocument.setParameter("form", "Product_Edition.html");
      xmlDocument.setParameter("window", windowId);
      ...
      xmlDocument.setParameter("language", "defaultLang=\"" + vars.getLanguage() + "\";");
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
      xmlDocument.setParameter("processId", "58591E3E0F7648E4A09058E037CE49FC");
      xmlDocument.setParameter("cancel", Utility.messageBD(this, "Cancel", vars.getLanguage()));
      xmlDocument.setParameter("ok", Utility.messageBD(this, "OK", vars.getLanguage()));
    ...
    xmlDocument.setParameter("M_Product_IdR", ProductData.selectActDefM_Product_Id(this, ""));
    ...
    Utility.fillSQLParameters(this, vars, (FieldProvider) vars.getSessionObject("button58591E3E0F7648E4A09058E037CE49FC.originalParams"), comboTableData, windowId, "");
