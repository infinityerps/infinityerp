...
public class ComboReloadsProcessHelper extends CalloutHelper {
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
   String strProcessId = vars.getStringParameter("inpadProcessId");
     ...
     if (strProcessId.equals("EF591985C486468F9B97B605D15A1633")) {
       processEF591985C486468F9B97B605D15A1633(response, vars, strTabId, windowId);
       return;
     }
    ...
    private void processD234AE084F7040DCB66E281A4237FF99(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
      ...
      if (CalloutHelper.commandInCommandList(command, "inp#adRoleId", "inp#adRoleId", "inp#adRoleId")) {
        if (!isFirst) resultado.append(", \n");
    ...
    private void processEF591985C486468F9B97B605D15A1633(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloadsEF591985C486468F9B97B605D15A1633';\n\n");
        resultado.append("var respuesta = new Array(\n");
    
        try {
          
      if (CalloutHelper.commandInCommandList(command, "inpdocstatus", "inpdocstatus")) {
        if (!isFirst) resultado.append(", \n");
        comboTableData = new ComboTableData(vars, this, "17", "action", "135", "535C7E50397B4CC28AD2B6C228E0DBF0", Utility.getReferenceableOrg(vars, vars.getStringParameter("inpadOrgId")), Utility.getContext(this, vars, "#User_Client", windowId), 0);
        comboTableData.fillParameters(null, windowId, "");
        resultField = "inpaction";
