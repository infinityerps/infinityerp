  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      printPageDefault(response, vars, strProcessId);
        ...
        printPageButtonEF591985C486468F9B97B605D15A1633(response, vars, strProcessId);
    ...
    } else if (vars.commandIn("BUTTON66BED6C42790460C979246FE4B19FC23")) {
        
        printPageButton66BED6C42790460C979246FE4B19FC23(response, vars, strProcessId);
    ...
    } else if (vars.commandIn("SAVE_BUTTONActionButtonEF591985C486468F9B97B605D15A1633")) {
        processEF591985C486468F9B97B605D15A1633(strProcessId, vars, request, response);
    ...
    } else if (vars.commandIn("SAVE_BUTTONActionButton66BED6C42790460C979246FE4B19FC23")) {
        process66BED6C42790460C979246FE4B19FC23(strProcessId, vars, request, response);
...
comboTableData = null;
    ...
    void printPageButtonEF591985C486468F9B97B605D15A1633(HttpServletResponse response, VariablesSecureApp vars, String strProcessId)
    throws IOException, ServletException {
      log4j.debug("Output: Button process EF591985C486468F9B97B605D15A1633");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/ActionButtonEF591985C486468F9B97B605D15A1633", discard).createXmlDocument();
      xmlDocument.setParameter("processing", "Y");
      xmlDocument.setParameter("form", "ActionButtonJava_Responser.html");
      xmlDocument.setParameter("css", vars.getTheme());
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
...
comboTableData = null;
    ...
    void printPageButton66BED6C42790460C979246FE4B19FC23(HttpServletResponse response, VariablesSecureApp vars, String strProcessId)
    throws IOException, ServletException {
      log4j.debug("Output: Button process 66BED6C42790460C979246FE4B19FC23");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/ActionButton66BED6C42790460C979246FE4B19FC23", discard).createXmlDocument();
      xmlDocument.setParameter("processing", "Y");
      xmlDocument.setParameter("form", "ActionButtonJava_Responser.html");
      xmlDocument.setParameter("css", vars.getTheme());
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
      ...
      {
        OBError myMessage = vars.getMessage("66BED6C42790460C979246FE4B19FC23");
        vars.removeMessage("66BED6C42790460C979246FE4B19FC23");
        if (myMessage!=null) {
          xmlDocument.setParameter("messageType", myMessage.getType());
          xmlDocument.setParameter("messageTitle", myMessage.getTitle());
          xmlDocument.setParameter("messageMessage", myMessage.getMessage());
...
params.put("importauditinfo", strimportauditinfo);
    ...
    private void processEF591985C486468F9B97B605D15A1633(String strProcessId, VariablesSecureApp vars, HttpServletRequest request, HttpServletResponse response) throws IOException,
      ServletException {
...
params.put("action", straction);
        ...
        OBError myMessage = null;
        try {
          new org.openbravo.erpCommon.ad_actionButton.ProcessRequisition().execute(pb);
          if((OBError)pb.getResult()!=null){
            myMessage = (OBError) pb.getResult();
            myMessage.setMessage(Utility.parseTranslation(this, vars, vars.getLanguage(), myMessage.getMessage()));
            myMessage.setTitle(Utility.parseTranslation(this, vars, vars.getLanguage(), myMessage.getTitle()));
...
params.put("recalculateprices", strrecalculateprices);
    ...
    private void process66BED6C42790460C979246FE4B19FC23(String strProcessId, VariablesSecureApp vars, HttpServletRequest request, HttpServletResponse response) throws IOException,
      ServletException {
        ...
        OBError myMessage = null;
        try {
          new org.openbravo.materialmgmt.VariantChDescUpdateBackgroundProcess().execute(pb);
          if((OBError)pb.getResult()!=null){
            myMessage = (OBError) pb.getResult();
            myMessage.setMessage(Utility.parseTranslation(this, vars, vars.getLanguage(), myMessage.getMessage()));
            myMessage.setTitle(Utility.parseTranslation(this, vars, vars.getLanguage(), myMessage.getTitle()));
