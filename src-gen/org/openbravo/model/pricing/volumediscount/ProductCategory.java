 ...
 * <br>
 * Help: {@literal Contains the discount configuration for the product category}
 * <br>
...
public class ProductCategory extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String TABLE_NAME = "M_Rappel_Productcategory";
    public static final String ENTITY_NAME = "PricingVolumeDiscountProductCategory";

    /**
     * Property id stored in column M_Rappel_Productcategory_ID in table M_Rappel_Productcategory 
     * 
     */
    public static final String PROPERTY_ID = "id";

    /**
     * Property client stored in column AD_Client_ID in table M_Rappel_Productcategory 
     * @see ClientEnabled 
     * 
     */
    ...
    /**
     * Property organization stored in column AD_Org_ID in table M_Rappel_Productcategory 
    ...
    /**
     * Property active stored in column IsActive in table M_Rappel_Productcategory 
     * @see ActiveEnabled 
     * 
     */
    ...
    /**
     * Property creationDate stored in column Created in table M_Rappel_Productcategory 
     * @see Traceable 
     * 
     */
    ...
    /**
     * Property createdBy stored in column CreatedBy in table M_Rappel_Productcategory 
     * @see Traceable 
     * 
     */
    ...
    /**
     * Property updated stored in column Updated in table M_Rappel_Productcategory 
     * @see Traceable 
     * 
     */
    ...
    /**
     * Property updatedBy stored in column UpdatedBy in table M_Rappel_Productcategory 
     * @see Traceable 
     * 
     */
    ...
    /**
     * Property volumeDiscount stored in column M_Rappel_ID in table M_Rappel_Productcategory<br>
    ...
    /**
     * Property productCategory stored in column M_Product_Category_ID in table M_Rappel_Productcategory<br>
    ...
    /**
     * @see ProductCategory#PROPERTY_VOLUMEDISCOUNT
     * 
     */
