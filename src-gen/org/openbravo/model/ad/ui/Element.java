 ...
 * <br>
 * Help: {@literal The Element Tab defines each system level element.}
 * <br>
...
public class Element extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    /**
     * Property id stored in column AD_Element_ID in table AD_Element<br>
    ...
    /**
     * Property client stored in column AD_Client_ID in table AD_Element 
     * @see ClientEnabled 
     * 
     */
    ...
    /**
     * Property organization stored in column AD_Org_ID in table AD_Element 
    ...
    /**
     * Property active stored in column IsActive in table AD_Element 
     * @see ActiveEnabled 
     * 
     */
    ...
    /**
     * Property creationDate stored in column Created in table AD_Element 
     * @see Traceable 
     * 
     */
    ...
    /**
     * Property createdBy stored in column CreatedBy in table AD_Element 
     * @see Traceable 
     * 
     */
    ...
    /**
     * Property updated stored in column Updated in table AD_Element 
     * @see Traceable 
     * 
     */
    ...
    /**
     * Property updatedBy stored in column UpdatedBy in table AD_Element 
     * @see Traceable 
     * 
     */
    ...
    /**
     * Property dBColumnName stored in column ColumnName in table AD_Element 
     * 
     */
    public static final String PROPERTY_DBCOLUMNNAME = "dBColumnName";

    /**
     * Property name stored in column Name in table AD_Element 
     * 
     */
    public static final String PROPERTY_NAME = "name";

    /**
     * Property printText stored in column PrintName in table AD_Element<br>
    ...
    /**
     * Property description stored in column Description in table AD_Element<br>
    ...
    /**
     * Property helpComment stored in column Help in table AD_Element<br>
    ...
    /**
     * Property purchaseOrderName stored in column PO_Name in table AD_Element<br>
    ...
    /**
     * Property printNameOnPurchaseOrder stored in column PO_PrintName in table AD_Element<br>
    ...
    /**
     * Property purchaseOrderDescription stored in column PO_Description in table AD_Element<br>
    ...
    /**
     * Property purchaseOrderHelp stored in column PO_Help in table AD_Element<br>
    ...
    /**
     * Property module stored in column AD_Module_ID in table AD_Element<br>
    ...
    /**
     * Property glossary stored in column IsGlossary in table AD_Element<br>
     * Help: {@literal This element is part of the glossary in wiki documentation.
     *       
     *       Glossary orphan elements are
     *       preserved when running Synchronize Terminology process.}
     * 
     */
    public static final String PROPERTY_GLOSSARY = "glossary";

    /**
     * Property aDElementTrlList stored in table AD_Element
     * 
     */
    ...
    public Element() {
        ...
        setDefaultValue(PROPERTY_GLOSSARY, false);
    ...
    /**
     * @see Element#PROPERTY_DBCOLUMNNAME
     * 
     */
    ...
    /**
     * @see Element#PROPERTY_PRINTTEXT
     * 
     */
    ...
    /**
     * @see Element#PROPERTY_HELPCOMMENT
     * 
     */
    ...
    /**
     * @see Element#PROPERTY_PURCHASEORDERNAME
     * 
     */
    ...
    /**
     * @see Element#PROPERTY_PRINTNAMEONPURCHASEORDER
     * 
     */
    ...
    /**
     * @see Element#PROPERTY_PURCHASEORDERHELP
     * 
     */
    ...
    /**
     * @see Element#PROPERTY_GLOSSARY
     * 
     */
    public Boolean isGlossary() {
        return (Boolean) get(PROPERTY_GLOSSARY);
    }
    /**
     * @see Element#PROPERTY_GLOSSARY
     * 
     */
    public void setGlossary(Boolean glossary) {
        set(PROPERTY_GLOSSARY, glossary);
    }
